...
class extCPUClass(baseCPUClass):
	...
	def cpi(self):hl=self.get_register_pair('HL');bc=self.get_register_pair('BC');a=self.registers['A'];value=self.memory[hl];result=a-value;self.set_register_pair('HL',hl+1&65535);self.set_register_pair('BC',bc-1&65535);self.set_flag('S',result&128);self.set_flag('Z',result==0);self.set_flag('H',(a&15)-(value&15)<0);self.set_flag('P/V',bc!=1);self.set_flag('N',1);self.set_flag('3',result&8);self.set_flag('5',result&32);self.cycles+=16